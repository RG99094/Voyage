  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden">
        ...
        {/* --- Duration Tag --- */}
        <div className="absolute top-4 right-4 bg-white/90 dark:bg-slate-900/80 text-teal-700 dark:text-teal-300 px-3 py-1 rounded-full text-sm font-bold backdrop-blur-sm">
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="flex justify-between items-center mt-auto">
          ...
          <button
            ...
            className="font-semibold text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 flex items-center gap-1 group/link"
          >
            Details
            <ArrowRight
              size={16}
