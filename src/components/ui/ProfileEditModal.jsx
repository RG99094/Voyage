  ...
  >
    <div className="flex items-center gap-4">
      ...
      <button
        ...
        className="flex items-center px-4 py-2 text-sm font-semibold text-teal-700 bg-teal-100 rounded-lg hover:bg-teal-200 transition-colors"
      >
    ...
    <div>
      ...
      <textarea
        ...
        onChange={handleChange}
        rows="3"
        className="w-full p-3 border border-slate-300 dark:border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 dark:bg-slate-700 dark:text-slate-200"
