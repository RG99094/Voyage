                ...
                >
                    ...
                    <div className="p-6 overflow-y-auto flex-grow custom-scrollbar">
                        ...
                        <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-4 flex items-center gap-2">
                            <TrendingUp size={20} className="text-teal-500" /> User Overview
                        </h3>
                                ...
                                {bookings.map((booking) => (
                                    ...
                                    >
                                        <div className="flex items-center gap-4 mb-2 md:mb-0">
                                            <div className="w-10 h-10 rounded-lg bg-teal-100 dark:bg-teal-900/30 flex items-center justify-center flex-shrink-0 text-teal-600 dark:text-teal-400 font-bold">
