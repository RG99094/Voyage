    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow-2xl w-full max-w-lg p-6 relative">
        ...
        <div className="border-t dark:border-slate-700 pt-4 space-y-2 text-gray-700 dark:text-slate-300">
          ...
          {/* ✅ Cab Booking Info */}
          {request.cabBooking && (
            <div className="mt-3 p-3 bg-teal-50 dark:bg-teal-900/30 rounded-md border border-teal-200 dark:border-teal-700">
              <p className="text-teal-700 dark:text-teal-300 font-semibold flex items-center gap-2 text-sm mb-1">
        ...
        <div className="p-4 border-b border-slate-200 dark:border-slate-700 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="relative w-full sm:w-1/3">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-slate-300 dark:border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 bg-transparent"
            />
          </div>
          ...
          <div className="relative w-full sm:w-auto">
            ...
            <select
              ...
              className="w-full sm:w-auto pl-10 pr-4 py-2 border border-slate-300 dark:border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 bg-transparent"
            >
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="border border-slate-300 dark:border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 bg-transparent py-2 pl-3 pr-8"
            >
