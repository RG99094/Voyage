    ...
    <div className="p-8 bg-slate-100 dark:bg-slate-900 min-h-screen">
          ...
          <div className="inline-flex min-w-full items-center justify-between gap-4 p-1 pr-4">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <button
                ...
                className="p-2 text-slate-500 hover:text-teal-600 hover:bg-teal-50 dark:text-slate-400 dark:hover:text-teal-400 dark:hover:bg-slate-700/50 rounded-lg transition-colors"
                title="Refresh Data"
              >
                <RefreshCw size={18} />
              </button>
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 bg-teal-600 hover:bg-teal-700 text-white text-sm font-medium rounded-lg transition-colors shadow-sm"
              >
                <Download size={16} />
                <span>Export</span>
              </button>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        >
          <div className="p-3 bg-emerald-100 dark:bg-emerald-900/50 rounded-lg">
            <IndianRupee className="text-emerald-600 dark:text-emerald-400" size={24} />
          </div>
          <div>
      ...
      >
        <h3 className="text-xl font-semibold text-slate-800 dark:text-slate-100 mb-4 flex items-center gap-2">
          <IndianRupee className="text-teal-600" /> Revenue & Transaction Volume
        </h3>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
            <div className="flex items-center gap-3 w-full sm:w-auto">
              ...
              <input
                ...
                className="border border-slate-300 dark:border-slate-700 rounded-md px-3 py-2 outline-none focus:ring-2 focus:ring-teal-500 w-full bg-transparent"
              />
            </div>
            ...
            <select
              ...
              onChange={handleTableFilterChange}
              className="border border-slate-300 dark:border-slate-700 dark:bg-slate-800 rounded-md px-3 py-2 focus:ring-2 focus:ring-teal-500 w-full sm:w-auto"
            >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
            <div className="flex items-center gap-2 w-full sm:w-auto">
              ...
              <select
                ...
                className="border border-slate-300 dark:border-slate-700 dark:bg-slate-800 rounded-md px-3 py-2 focus:ring-2 focus:ring-teal-500 w-full"
              >
            ...
            <Button
              onClick={handleExportCSV}
              className="bg-teal-600 hover:bg-teal-700 text-white flex items-center gap-2 px-4 py-2 rounded-md w-full sm:w-auto"
            >
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-2 w-full lg:w-auto">
            <input
              ...
              onChange={handleTableFilterChange}
              className="border border-slate-300 dark:border-slate-700 dark:bg-slate-800 rounded-md px-2 py-2 focus:ring-2 focus:ring-teal-500 w-full sm:w-auto"
            />
              ...
              filteredTransactions
                ...
                .map((t) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-teal-600 dark:text-teal-400 font-semibold">
                      {formatRupee(t.amount)}
                      {t.cabBooking && (
                        <div className="text-[10px] text-teal-600 dark:text-teal-400 mt-0.5 flex items-center gap-0.5 font-medium">
