      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full border border-slate-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-teal-500 dark:bg-slate-700 dark:border-slate-600 dark:text-slate-200 dark:placeholder-slate-400"
            />
            {errors.name && (
        ...
        <div className="mt-4">
          ...
          <textarea
            ...
            // ✅ FIX: Added full dark mode classes
            className="w-full border border-slate-300 rounded-md px-3 py-2 h-24 focus:ring-2 focus:ring-teal-500 dark:bg-slate-700 dark:border-slate-600 dark:text-slate-200 dark:placeholder-slate-400"
          />
          {errors.description && (
        ...
        <div className="mt-4">
          ...
          <textarea
            ...
            // ✅ FIX: Added full dark mode classes
            className="w-full border border-slate-300 rounded-md px-3 py-2 h-20 focus:ring-2 focus:ring-teal-500 dark:bg-slate-700 dark:border-slate-600 dark:text-slate-200 dark:placeholder-slate-400"
          />
        </div>
        ...
        <Button
          type="submit"
          disabled={loading}
          className="w-full bg-teal-600 hover:bg-teal-700 text-white font-semibold py-3 rounded-md mt-6"
        >
          {loading
            ? isEditing
              ? "Updating..."
