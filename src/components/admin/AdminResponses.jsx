      ...
      >
        <div className="p-6 overflow-y-auto">
          ...
          <textarea
            ...
            rows="8"
            className="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 dark:bg-slate-900 dark:border-slate-600 dark:text-slate-200"
            required
            readOnly={isViewing}
          />
