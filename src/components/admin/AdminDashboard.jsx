...
const COLORS = ["#14b8a6", "#0ea5e9", "#facc15", "#ef4444", "#8b5cf6"];
  ...
  if (active && payload && payload.length) {
    return (
      <div className="bg-slate-800 dark:bg-slate-900 p-3 rounded-md shadow-lg border border-slate-700">
        ...
        <p className="text-teal-400">{`Bookings: ${payload[0].value}`}</p>
      </div>
    );
  }
  return null;
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            ...
            <motion.div
              ...
              className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-md flex flex-col items-center text-center border border-slate-100 dark:border-slate-700"
            >
              <Briefcase className="text-teal-600 mb-3" size={32} />
              <h3 className="text-2xl font-bold text-slate-800 dark:text-slate-100">
                {stats.totalBookings}
              </h3>
            ...
            <motion.div
              ...
              className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-md flex flex-col items-center text-center border border-slate-100 dark:border-slate-700"
            >
              <IndianRupee className="text-teal-600 mb-3" size={32} />
              <h3 className="text-2xl font-bold text-slate-800 dark:text-slate-100">
              ...
              <div className="inline-flex min-w-full items-center justify-start gap-4 p-1 pr-4">
                ...
                <div className="ml-auto flex items-center gap-2" data-html2canvas-ignore>
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 bg-teal-600 hover:bg-teal-700 text-white text-sm font-medium rounded-lg transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isExporting ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-slate-800 dark:text-slate-100 mb-4 text-center">
                    <BarChartHorizontal className="inline-block mr-2 text-teal-600" />
