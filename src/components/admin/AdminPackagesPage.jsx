      ...
      <div className="bg-white dark:bg-slate-800 p-5 rounded-xl shadow-md flex flex-col lg:flex-row items-center justify-between gap-4 mb-8 border border-slate-100 dark:border-slate-700">
        ...
        <div className="flex items-center gap-3 w-full lg:w-1/3">
          ...
          <input
            ...
            className="border border-slate-300 dark:border-slate-600 rounded-md px-3 py-2 outline-none focus:ring-2 focus:ring-teal-500 w-full dark:bg-slate-700 dark:text-slate-200"
          />
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
          <select
            ...
            className="border border-slate-300 dark:border-slate-600 rounded-md px-3 py-2 focus:ring-2 focus:ring-teal-500 w-full sm:w-auto dark:bg-slate-700 dark:text-slate-200"
          >
            {categories.map((cat) => (
          ...
          <Button
            ...
            className="bg-teal-600 hover:bg-teal-700 text-white font-semibold flex items-center gap-2 px-4 py-2 rounded-md w-full sm:w-auto shadow-teal-500/30"
          >
                ...
                <div className="mt-auto pt-4">
                  ...
                  <div className="flex flex-col sm:flex-row justify-start gap-2 mt-4">
                    <Button
                      ...
                      className="bg-teal-600 hover:bg-teal-700 text-white px-3 py-1.5 text-sm w-full sm:w-auto"
                    >
                      <Edit size={14} /> Edit
                    </Button>
