                ...
                <div>
                  ...
                  <div className="mt-1 flex items-center gap-4">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-teal-700 bg-teal-100 rounded-lg hover:bg-teal-200 dark:bg-teal-900/30 dark:text-teal-300 dark:hover:bg-teal-800/40 transition-colors"
                    >
