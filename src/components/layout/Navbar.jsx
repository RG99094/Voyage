    ...
    >
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <Link
          ...
          className={cn(
            "text-3xl font-bold",
            isOverHero ? "text-white" : "text-teal-600 dark:text-teal-400"
          )}
        >
          Voyage
        </Link>
          ...
          <button
            ...
            className={cn(
              ...
              isOverHero
                ...
                : "bg-teal-50 hover:bg-teal-100 text-teal-600 dark:bg-slate-700 dark:hover:bg-slate-600 dark:text-teal-400"
            )}
