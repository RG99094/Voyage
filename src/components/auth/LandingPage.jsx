      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-12">
          ...
          <motion.div
            ...
            className="group w-80 h-96 bg-white/10 rounded-2xl shadow-xl p-8 flex flex-col items-center justify-center text-center cursor-pointer border border-white/20 hover:border-teal-400/40 backdrop-blur-md"
            onClick={() => navigate("/register")}
          >
            <User
              size={80}
              className="text-teal-200 mb-6 transition-transform duration-300 group-hover:scale-110"
            />
