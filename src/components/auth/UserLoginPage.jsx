      ...
      >
        <AnimatePresence mode="wait">
              ...
              >
                <motion.div variants={itemVariants} className="relative">
                  ...
                  <input
                    ...
                    className={cn(
                      ...
                      isEmailFocused && "ring-2 ring-teal-400"
                    )}
                  />
                </motion.div>
                ...
                <motion.div variants={itemVariants} className="relative">
                  ...
                  <input
                    ...
                    className={cn(
                      "w-full pl-12 pr-4 py-3 bg-white/10 text-white placeholder-slate-300 border border-white/20 rounded-lg focus:outline-none",
                      isPasswordFocused && "ring-2 ring-teal-400"
                    )}
                  />
                </motion.div>
                ...
                <motion.div variants={itemVariants} className="text-right -mt-2">
                  <button
                    ...
                    className="text-sm font-semibold text-teal-300 hover:text-teal-200 hover:underline"
                  >
                    Forgot password?
                  </button>
                </motion.div>
          ...
          {view === "forgot" && (
            ...
            >
              <div className="text-center mb-10">
                <Key size={50} className="text-teal-300 mx-auto mb-4" />
          ...
          {view === "verify_otp" && (
            ...
            >
              <div className="text-center mb-10">
                <CheckSquare size={50} className="text-teal-300 mx-auto mb-4" />
          ...
          {view === "reset_password" && (
            ...
            >
              <div className="text-center mb-10">
                <RotateCcw size={50} className="text-teal-300 mx-auto mb-4" />
              ...
              >
                <motion.div variants={itemVariants} className="relative">
                  ...
                  <input
                    ...
                    className={cn(
                      "w-full pl-12 pr-4 py-3 bg-white/10 text-white placeholder-slate-300 border border-white/20 rounded-lg focus:outline-none",
                      isNewPasswordFocused && "ring-2 ring-teal-400"
                    )}
                  />
                </motion.div>
                ...
                <motion.div variants={itemVariants} className="relative">
                  ...
                  <input
                    ...
                    className={cn(
                      "w-full pl-12 pr-4 py-3 bg-white/10 text-white placeholder-slate-300 border border-white/20 rounded-lg focus:outline-none",
                      isConfirmPasswordFocused && "ring-2 ring-teal-400"
                    )}
                  />
                </motion.div>
