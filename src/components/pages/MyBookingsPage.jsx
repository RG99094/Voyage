  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        isCompletedTrip
          ...
          : isActiveTrip
            ? "bg-white dark:bg-slate-800 border-2 border-teal-500 dark:border-teal-400 shadow-teal-100 ring-4 ring-teal-50 dark:ring-teal-900/20"
            : booking.isAddOn
    ...
    >
      <button
        ...
        className="absolute top-6 left-5 text-slate-400 hover:text-teal-600 dark:hover:text-teal-400 transition-colors z-20"
        title="View Details"
      >
        <Info size={22} />
      </button>
      ...
      <div className="p-6 pl-16">
        ...
        {isActiveTrip && (
          <div className="flex items-center gap-2 mb-3 p-2 bg-teal-50 dark:bg-teal-900/30 text-teal-700 dark:text-teal-300 rounded-md border border-teal-200 dark:border-teal-700 animate-pulse">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-slate-700 dark:text-slate-300">
          ...
          <div className="flex items-center gap-3 overflow-hidden">
            <Hash size={18} className="text-teal-600 dark:text-teal-400 flex-shrink-0" />
...
const MyBookingsPage = () => {
  ...
  const inputBaseClass =
    "border border-slate-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-teal-500 outline-none dark:bg-slate-700 dark:border-slate-600 dark:text-slate-200 w-full";
    ...
    <div className="pt-32 pb-24 bg-slate-50 dark:bg-slate-900 min-h-screen">
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <p className="text-xl text-slate-600 dark:text-slate-300 text-center mb-10 max-w-3xl mx-auto">
          Here’s a summary of your adventures with Voyage.
        </p>
