    ...
    <div className="bg-slate-50 dark:bg-slate-900 pt-20 md:pt-32 pb-20">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <button
          ...
          className="flex items-center text-teal-600 dark:text-teal-400 font-semibold mb-6 md:mb-8 hover:underline text-sm md:text-base"
        >
        ...
        <div className="grid lg:grid-cols-3 gap-6 lg:gap-12">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start mb-4 gap-4 md:gap-0">
                  ...
                  <div className="flex gap-2 flex-shrink-0 self-end md:self-auto">
                    ...
                    >
                      <Bookmark
                        size={20}
                        className={cn(isSaved && "fill-teal-500 text-teal-500")}
                      />
                    </Button>
                ...
                <div className="mt-10 border-t border-slate-200 dark:border-slate-700 pt-8">
                  ...
                  {isUserAuthenticated ? (
                      ...
                      {ratingSuccess ? (
                        ...
                        <form onSubmit={handleRatingSubmit} className="space-y-4">
                          ...
                          <textarea
                            ...
                            rows="3"
                            className="w-full p-3 border border-slate-300 dark:border-slate-600 rounded-lg dark:bg-slate-700 dark:text-slate-200 focus:ring-2 focus:ring-teal-500"
                          />
                    ...
                    <div className="text-slate-500 dark:text-slate-400 italic">
                      Please <span onClick={() => navigate("/login")} className="text-teal-600 cursor-pointer hover:underline">log in</span> to write a review.
                    </div>
                  )}
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-slate-800 p-5 md:p-8 rounded-2xl shadow-xl sticky top-28 border dark:border-slate-700">
              ...
              <div className="text-2xl md:text-3xl font-bold text-teal-600 dark:text-teal-400 mb-6">
              ...
              <form onSubmit={handleSubmitToPayment} className="space-y-4">
                        ...
                        <div className="space-y-1">
                          <input
                            ...
                            className={cn(
                              ...
                              "file:bg-teal-600 file:hover:bg-teal-700",
                ...
                {/* ✅ --- CAB BOOKING OPTION --- */}
                <div className="flex items-start gap-3 p-3 bg-teal-50 dark:bg-teal-900/20 border border-teal-100 dark:border-teal-800 rounded-lg">
                  {duplicateInfo?.cabBooking ? (
                    <div className="w-full flex items-center gap-3">
                      <CheckCircle size={20} className="text-teal-600 dark:text-teal-400 flex-shrink-0" />
                      <div>
                    ...
                    <>
                      <input
                        ...
                        className="mt-1 w-4 h-4 text-teal-600 rounded focus:ring-teal-500 cursor-pointer"
                      />
                      <label htmlFor="cabBooking" className="text-sm cursor-pointer flex-1">
                        ...
                        <span className="text-teal-600 dark:text-teal-400 font-bold text-sm block mt-1">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full p-3 !py-2.5 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 dark:bg-slate-700 dark:border-slate-600 dark:text-slate-200 text-sm"
                  />
                </div>
