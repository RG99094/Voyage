...
import AIChatPopup from "../chat/AIChatPopup"; // ✅ Import Chat Popup
...
const HomePage = ({
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            {[
              ...
              <motion.div
                ...
                className="p-6"
              >
                <div className="mx-auto bg-teal-100 text-teal-600 rounded-full h-20 w-20 flex items-center justify-center mb-6">
                  <Icon size={40} />
                </div>
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-800">
        ...
        <div className="container mx-auto px-6">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="bg-teal-600 rounded-3xl p-12 text-white text-center shadow-2xl shadow-teal-500/30 relative overflow-hidden"
          >
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                      <input
                        ...
                        className="w-full bg-white/20 border border-white/30 rounded-lg px-5 py-3 text-white placeholder-teal-100 focus:outline-none focus:ring-2 focus:ring-white disabled:opacity-75 disabled:cursor-not-allowed"
                        required
      ...
      {/* 🤖 AI Chat Popup (Only for logged-in users) */}
      {isUserAuthenticated && <AIChatPopup currentUser={currentUser} />}
    </>
  );
};
