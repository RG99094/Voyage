        ...
        <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg mb-12 border border-slate-100 dark:border-slate-700 backdrop-blur-md">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <select
              ...
              onChange={handleFilterChange}
              className="border border-slate-300 rounded-md px-3 py-2 text-slate-700 focus:ring-2 focus:ring-teal-500 w-full md:w-auto dark:bg-slate-700 dark:border-slate-600 dark:text-slate-200"
            >
              {categories.map((cat) => (
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <input
              ...
              value={filters.price}
              onChange={handleFilterChange}
              className="w-full sm:w-1/2 accent-teal-600"
            />
