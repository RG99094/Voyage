...
const InfoCard = ({ icon: Icon, label, value }) => (
  <div className="bg-white dark:bg-slate-800 p-5 rounded-lg shadow-md border border-slate-100 dark:border-slate-700">
    <Icon className="w-8 h-8 text-teal-600 dark:text-teal-400 mb-3" />
      ...
      <div className="container mx-auto px-6 max-w-5xl">
          ...
          <InfoCard
            ...
            value={
              <div>
                ...
                {booking.cabBooking && (
                  <div className="text-xs text-teal-600 dark:text-teal-400 font-semibold flex items-center gap-1 mt-1">
        ...
        >
          ...
          <div className="lg:col-span-2 bg-white dark:bg-slate-800 p-8 rounded-lg shadow-lg border border-slate-100 dark:border-slate-700">
            ...
            <h3 className="text-lg font-semibold text-teal-600 dark:text-teal-400 mb-4 pb-2 border-b border-gray-100 dark:border-gray-700">Package Details</h3>
            ...
            <h3 className="text-lg font-semibold text-teal-600 dark:text-teal-400 mt-8 mb-4 pb-2 border-b border-gray-100 dark:border-gray-700">Your Details</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-2">
            ...
            <h3 className="text-lg font-semibold text-teal-600 dark:text-teal-400 mt-8 mb-4 pb-2 border-b border-gray-100 dark:border-gray-700">Payment & Notes</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-2">
