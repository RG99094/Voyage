    ...
    <div className="pt-32 pb-24 container mx-auto px-6 max-w-5xl">
      ...
      >
        ...
        >
          ...
          <div className="absolute -inset-1 rounded-full bg-gradient-to-tr from-teal-400 via-teal-500 to-emerald-400 opacity-0 group-hover/avatar:opacity-70 blur-sm transition-all duration-500" />
          ...
          {imageUploading && (
            <div className="absolute inset-0 rounded-full bg-black/50 backdrop-blur-sm flex items-center justify-center z-10">
              <div className="w-10 h-10 border-[3px] border-white/30 border-t-teal-400 rounded-full animate-spin" />
            </div>
          )}
          {/* Hidden File Input */}
          <input
...
const PackageCardButtons = ({
  ...
  return (
    <>
      ...
      >
        <Bookmark size={18} className={cn(isSaved && "fill-teal-500 text-teal-500")} />
      </button>
      <button
        onClick={onLikeClick}
        className={cn(
