    ...
    <div className="pt-32 pb-24 bg-white dark:bg-slate-900 min-h-screen">
      <div className="container mx-auto px-6">
        ...
        <p className="text-xl text-slate-600 dark:text-slate-300 text-center mb-16 max-w-3xl mx-auto">
          Voyage isn’t just a travel company — it’s a community of dreamers,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-24">
          ...
          <div>
            <h2 className="text-3xl font-bold mb-4 text-teal-600 flex items-center">
        ...
        <div className="mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            {[
              {
                icon: (
                  <Heart size={40} className="mx-auto text-teal-600 mb-4" />
                ),
                title: "Passion",
              ...
              {
                icon: (
                  <Globe size={40} className="mx-auto text-teal-600 mb-4" />
                ),
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center mb-24">
          {[
            {
              icon: <Users className="text-teal-600 mx-auto mb-3" size={42} />,
              number: "20K+",
              label: "Happy Travelers",
            },
            {
              icon: <Compass className="text-teal-600 mx-auto mb-3" size={42} />,
              number: "150+",
              label: "Destinations",
            },
            {
              icon: <Heart className="text-teal-600 mx-auto mb-3" size={42} />,
