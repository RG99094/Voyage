    ...
    return (
        <div className="flex flex-col h-[calc(100vh-64px)] overflow-hidden bg-white">
            ...
            <div className="bg-white/80 backdrop-blur-md border-b border-gray-200/60 p-4 flex items-center justify-between z-10 shrink-0 sticky top-0">
                <div>
                    <h1 className="text-2xl font-serif text-teal-900 font-bold flex items-center gap-2">
                ...
                <div className="flex items-center gap-4">
                    <div className="relative group">
                        <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 w-4 h-4 group-focus-within:text-teal-500 transition-colors" />
                        <select
                            className="pl-9 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm font-medium text-gray-700 outline-none ring-2 ring-transparent focus:ring-teal-500/20 focus:border-teal-500 transition-all hover:bg-white hover:border-gray-300 w-48 appearance-none cursor-pointer"
                            value={selectedState}
                            ...
                            >
                                <div className="max-w-[240px] p-1 font-sans">
                                    ...
                                    <div className="flex items-center justify-between mb-3 bg-gray-50 p-2 rounded-md border border-gray-100">
                                        ...
                                        <span className="font-bold text-teal-700">₹{selectedMarker.estimatedPrice}</span>
                                    </div>
                    ...
                    <div className="p-5 border-b border-gray-100 bg-white sticky top-0 z-10">
                        ...
                        <div className="mt-4 relative">
                            ...
                            <input
                                ...
                                className="w-full pl-9 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 transition-all"
                                value={searchQuery}
                                ...
                                return (
                                    <div
                                        ...
                                        className={`group flex items-start gap-3 p-3 rounded-xl border transition-all cursor-pointer relative overflow-hidden bg-white ${hoveredPlace === place._id
                                            ? "border-teal-400 shadow-md ring-1 ring-teal-400/20 -translate-y-0.5"
                                            : "border-gray-100 hover:border-teal-300 hover:shadow-lg hover:shadow-gray-100"
                                            }`}
                                    ...
                                    >
                                        <div className="relative w-24 h-24 rounded-lg overflow-hidden shrink-0 group-hover:shadow-md transition-all">
                                            ...
                                            />
                                            {isSelected && (
                                                <div className="absolute inset-0 bg-teal-900/40 flex items-center justify-center backdrop-blur-[1px]">
                                        ...
                                        <div className="flex-1 min-w-0 flex flex-col h-full justify-between py-0.5">
                                            <div>
                                                <div className="flex justify-between items-start">
                                                    <h3 className="font-bold text-gray-800 text-sm truncate pr-2 group-hover:text-teal-700 transition-colors">
                                                        {place.name}
                                                    </h3>
                                                </div>
                                            ...
                                            <div className="mt-2 flex items-center justify-between">
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-sm font-bold text-teal-600">₹{place.estimatedPrice}</span>
                                                </div>
                                                <button
                                                    onClick={(e) => {
                                                        e.stopPropagation();
                    ...
                    {selectedPlaces.length > 0 && (
                        <div className="bg-white border-t border-gray-200 p-4 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] z-30">
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <span className="text-xl font-bold text-teal-800">₹{totalEstimatedPrice.toLocaleString()}</span>
                            </div>
                            ...
                            <button
                                onClick={handleBooking}
                                className="w-full py-3 bg-teal-600 hover:bg-teal-700 text-white font-bold rounded-xl shadow-lg shadow-teal-200 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                            >
